...
public class FollowingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!username.equals(ParseUser.getCurrentUser().getUsername())) {
            ...
            followingTextView.setText("Takip ettikleri");
        }
        ...
        query.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject object, ParseException e) {
                if (e==null) {
                    Log.i("UserInfo query for following list", "Success");
                    ...
                    final ArrayList<String> followingList = gson.fromJson(json, type);

                    LinearLayout linearLayout = findViewById(R.id.selfFollowingList);

                    for (int i = 0; i < followingList.size(); i++) {

                        final int inner_i = i;

                        LinearLayout rowLinearLayout = new LinearLayout(FollowingActivity.this);
                        ...
                        final CircleImageView followingUserImg = new CircleImageView(FollowingActivity.this);
                        ...
                        followingImgQuery.whereEqualTo("username", followingList.get(i));
                        ...
                        TextView followingUsername = new TextView(FollowingActivity.this);
                        ...
                        followingUsername.setText(followingList.get(i));
                        ...
                        rowLinearLayout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("username", followingList.get(inner_i));
